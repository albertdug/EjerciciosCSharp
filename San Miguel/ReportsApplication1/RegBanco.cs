...
{
    public partial class RegBanco : Form
    {
        ...
        private void RegBanco_Load(object sender, EventArgs e)
        {
            CenterToScreen();
        ...
        {
            Enlace.Open();
            String sql = "insert into tipob (nombreb,estatusb) values('" + textBox1.Text + "','A')";
